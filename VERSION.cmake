...
set(MIRALL_PREVERSION_HUMAN "5.0.11")  # For preversions where PATCH>=50. Use version + alpha, rc1, rc2, etc.
...
string(TIMESTAMP BUILD_TAG "%Y%m%d")
...
# Base version string (e.g. 3.16.50-daily)
set(MIRALL_VERSION_STRING "${MIRALL_VERSION}-${MIRALL_VERSION_SUFFIX}")

#Make version.txt
file(REMOVE ${CMAKE_CURRENT_BINARY_DIR}/version.txt)
